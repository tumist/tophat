...
export const MemMonitor = GObject.registerClass({
    Properties: {
        'show-mem-swap': GObject.ParamSpec.boolean(
            'show-mem-swap',
            'Swap meter',
            'Show swap bar meter',
        ...
        _init(configHandler) {
            ...
            configHandler.settings.bind('show-mem-swap', this, 'show-mem-swap', Gio.SettingsBindFlags.GET);
            ...
            this._signals.push(
                this.connect('notify::show-mem-swap', () => {
                    this._buildMeter();
                })
            );
        ...
        _buildMeter() {
            this.setMeter(new Monitor.Meter(this.show_mem_swap ? 2 : 1, this.meter_bar_width));
        }
        ...
        _refreshCharts() {
            ...
            if (this.show_mem_swap) {
                this.meter.setUsage([this.memUsage.mem * 100, this.memUsage.swap * 100]);
            } else {
        ...
        destroy() {
            ...
            Gio.Settings.unbind(this, 'show-mem-swap');
